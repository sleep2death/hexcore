...
func TestLogger(t *testing.T) {
	...
	performRequest(router, "/example?a=100")
	assert.Contains(t, buffer.String(), "/example")
	assert.Contains(t, buffer.String(), "a=100")

	buffer.Reset()
	performRequest(router, "/notfound")
...
func TestErrorLogger(t *testing.T) {
	...
	// TODO: errorlogger test
	// router.Handle("/error", func(c *Context) {
	// 	c.Error(errors.New("this is an error")) // nolint: errcheck
	// })
	// router.Handle("/abort", func(c *Context) {
	// 	c.AbortWithError(errors.New("no authorized")) // nolint: errcheck
	// })
	// router.Handle("/print", func(c *Context) {
	// 	c.Error(errors.New("this is an error")) // nolint: errcheck
	// 	// c.String(http.StatusInternalServerError, "hola!")
	// })

	// performRequest(router, "/error")
...
func TestLoggerWithWriterSkippingPaths(t *testing.T) {
	...
	performRequest(router, "/logged")
	assert.Contains(t, buffer.String(), "/logged")

	buffer.Reset()
	performRequest(router, "/skipped")
